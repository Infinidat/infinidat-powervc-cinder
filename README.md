...
```
% git clone git@git.infinidat.com:host-internal/PowerVC.git
% cd PowerVC
```
* Or download the source code from Gitlab: [PowerVC|https://git.infinidat.com/host-internal/PowerVC]:
```
% tar xf PowerVC-2.2.0.tar.gz
% cd PowerVC
```
